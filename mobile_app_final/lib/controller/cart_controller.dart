...
class CartController extends GetxController implements GetxService {
  ...
  void setQuantity(bool isIncrement, int index, double value) {
    _amount = 0;
    if (isIncrement == true) {
      if (_customerCartList[_customerIndex].cart[index].product.quantity >
        ...
        print(_customerCartList[_customerIndex].cart.length);
        print(index);
        for (int i = 0;
      ...
      if (_customerCartList[_customerIndex].cart[index].product.quantity >
          _customerCartList[_customerIndex].cart[index].quantity) {
        _customerCartList[_customerIndex].cart[index].quantity = value;
