...
class ItemCartWidget extends StatelessWidget {
  ...
  ItemCartWidget({Key key, this.cartModel, this.index}) : super(key: key);
                      ...
                      return Container(
                        child: Row(
                          children: [
                            InkWell(
                              onTap: () {
                                cartController.setQuantity(false, index, 7);
                              },
                              child: Padding(
                            ...
                            InkWell(
                              onTap: () {
                                cartController.setQuantity(true, index, 9);
                              },
                              child: Padding(
                                padding: const EdgeInsets.symmetric(
                                    horizontal:
