...
class StockLimitedProducts {
  ...
  StockLimitedProducts.fromJson(Map<String, dynamic> json) {
    ...
    _unitType = int.tryParse(json['unit_type'].toString());
    _unitValue = int.tryParse(json['unit_value'].toString());
    ...
    if (json['selling_price'] != null) {
      _sellingPrice = double.parse(json['selling_price']).toDouble();
    } else {
      _sellingPrice = 0.0;
    }
    ...
    if (json['discount'] != null) {
      _discount = double.parse(json['discount']).toDouble();
    } else {
      _discount = 0.0;
    }

    if (json['tax'] != null) {
      _tax = double.parse(json['tax']).toDouble();
    } else {
      _tax = 0.0;
    }
    ...
    _image = json['image'];
    _orderCount = int.parse(json['order_count']);
    _supplierId = int.parse(json['supplier_id']);
...
class CategoryIds {
  ...
  CategoryIds.fromJson(Map<String, dynamic> json) {
    _id = json['id'];
    _position = int.parse(json['position']);
  }
