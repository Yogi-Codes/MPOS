class AccountModel {
  ...
  AccountModel({int total, int limit, int offset, List<Accounts> accounts}) {
    if (total != null) {
      this._total = total;
    }
    if (limit != null) {
...
class Accounts {
  ...
  Accounts.fromJson(Map<String, dynamic> json) {
    ...
    if (json['total_in'] != null) {
      _totalIn = double.parse(json['total_in']).toDouble();
    } else {
      _totalIn = 0.0;
    }
    if (json['total_out'] != null) {
      _totalOut = double.parse(json['total_out']).toDouble();
    } else {
      _totalOut = 0.0;
    }
